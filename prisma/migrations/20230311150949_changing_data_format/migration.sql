...
*/
-- DropForeignKey
ALTER TABLE "Car" DROP CONSTRAINT "Car_renterId_fkey";
...
CREATE TABLE "Advert" (
    ...
    CONSTRAINT "Advert_pkey" PRIMARY KEY ("idcar")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Advert_emailrenter_key" ON "Advert"("emailrenter");
